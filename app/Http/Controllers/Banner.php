...
class Banner extends Controller
{
    ...
    {
        $data=tblbanner::all();
		return view('admin.banner_list', ['dt' => $data]);
    }
    ...
    public function update(Request $request)
    {
        $this->validate($request, [
				...
				'lower_iamge_content' => 'required',
				'sts' => 'required',
				'home_popup_title' => 'required',
				'home_popup_content' => 'required',
				'home_popup_iframe' => 'required',
				'seo_title' => 'required',
        ...
        if (Input::file('image')->isValid()) {
			...
			// sending back with message
				...
				$post->lower_iamge_content=$request['lower_iamge_content'];
				$post->sts=$request['sts'];
				$post->home_popup_title=$request['home_popup_title'];
				$post->home_popup_content=$request['home_popup_content'];
				$post->home_popup_iframe=$request['home_popup_iframe'];
