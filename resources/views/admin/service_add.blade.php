            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
					...
					<div class="form-group">
						...
						{!! Form::open(array('route' => 'services.store','id'=>'form1','files'=>true,'enctype'=>
						'multipart/form-data')) !!}
							<div class="form-group">
							...
							<div class="form-group">
								...
								<label for="name">Directory Content</label>
                                                                <textarea name="services_content" id="editor1" class="form-control" rows="4" cols="50"></textarea>
								<!--<input type="text" name="services_content" class="form-control" id="services_content" />-->
							</div>
							<div class="form-group">
